<?php
    define( 'MAIL_TO', /* >>>>> */'oualid.bentaleb1@gmail.com'/**/ );  //ajouter votre courriel
...
body{ width:772px; margin:0 auto; padding:0;background-image: url("phone-612061_1280.jpg"); }
...
p em{ display:block; font-weight:normal; }
    ...
    <body>
      <div id="element_menu" style="display: flex;">
        <a href="http://bentech.esy.es/Portfolio/Accueil,/indx.html" style="text-decoration: none;"><p class="element_menu5" style="width: 126px;font-size: 20px;margin-left: -29vw;color: white;">Accueil</p></a>
        <a href="http://bentech.esy.es/Portfolio/Portf/Accueil_Porfolio/porfolio.html" style="text-decoration: none;"><p class="element_menu6" style="width: 126px;font-size: 20px;margin-left: -24vw;color: white;">Portfolio</p></a>
        <a href="http://bentech.esy.es/Portfolio/Contact/contact.php" style="text-decoration: none;"><p class="element_menu7" style="width: 126px;font-size: 20px;margin-left: -18vw;color: white;">Contact</p></a>
                                                            </div>
        <h1>Contact</h1>
        <hr />
<?php
